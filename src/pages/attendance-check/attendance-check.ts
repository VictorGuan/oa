...
export class AttendanceCheckPage {
  ...
  handleSelect (item) {
    //this.modalCtrl.create('AttendanceCheckDetailPage').present();
    //this.navCtrl.push('AttendanceCheckDetailPage',{item:item});
    this.navCtrl.push('AttendanceCheckDetailPage',{item:item,"view":"position"});
  }
